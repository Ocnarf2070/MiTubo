...
grant alter SYSTEM to R_ADMINISTRADOR;
--grant execute on U_ADMINISTRADOR.SIMULAR_VIDEO to J;
GRANT ALTER USER to R_ADMINISTRADOR;
GRANT RESOURCE TO R_ADMINISTRADOR;
...
GRANT EXECUTE ON U_ADMINISTRADOR.GESTION_VIDEOS to R_USUARIO;
GRANT EXECUTE ON U_ADMINISTRADOR.PROC_CREATE_USER to R_USUARIO;
GRANT EXECUTE ON U_ADMINISTRADOR.PROC_MODIFICA to R_USUARIO;
